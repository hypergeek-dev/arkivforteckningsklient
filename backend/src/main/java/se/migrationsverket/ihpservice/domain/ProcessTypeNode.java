...
@SuperBuilder
public class ProcessTypeNode extends StructureTypeNode implements Domain, DomainMapper<ProcessTypeNodeDto, ProcessTypeNodeEntity> {
    ...
    public ProcessTypeNodeDto mapToDto() {
        return ProcessTypeNodeDto.builder()
    ...
    @Override
    public ProcessTypeNodeEntity mapToEntity() {
        return ProcessTypeNodeEntity.builder()
                .id(getId())
    ...
    @Override
    public ProcessTypeNodeEntity mapToEntity(String userId) {
        return ProcessTypeNodeEntity.builder()
                .parentId(getParentId())
                .replacesId(getReplacesId())
                .name(getName())
